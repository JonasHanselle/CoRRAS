...
bp.axes.axhline(df_baseline["tau_corr"].mean(), ls="--", label="rf-baseline-mean")
...
bp.axes.axhline(df_baseline["mse"].mean(), ls="--", label="rf-baseline-mean")
...
bp.axes.axhline(df_baseline["mae"].mean(), ls="--", label="rf-baseline-mean")
...
bp.axes.axhline(df_baseline["abs_distance_to_vbs"].mean(), ls="--", label="rf-baseline-mean")
...
bp.axes.axhline(df_baseline["ndcg"].mean(), ls="--", label="rf-baseline-mean")
...
plt.clf()
bp = sns.lineplot(x="lambda", y="tau_corr", data=df_corras)
bp.axes.axhline(df_baseline["tau_corr"].mean(), ls="--", label="rf-baseline-mean")
bp.axes.axhline(df_baseline["tau_corr"].median(), ls="--", color="r", label="rf-baseline-median")
plt.title(scenario_name)
plt.legend()
...
plt.clf()
bp = sns.lineplot(x="lambda", y="ndcg", data=df_corras)
bp.axes.axhline(df_baseline["ndcg"].mean(), ls="--", label="rf-baseline-mean")
bp.axes.axhline(df_baseline["ndcg"].median(), ls="--", color="r", label="rf-baseline-median")
plt.title(scenario_name)
plt.legend()
...
plt.clf()
bp = sns.lineplot(x="lambda", y="abs_distance_to_vbs", data=df_corras)
bp.axes.axhline(df_baseline["abs_distance_to_vbs"].mean(), ls="--", label="rf-baseline-mean")
bp.axes.axhline(df_baseline["abs_distance_to_vbs"].median(), ls="--", color="r", label="rf-baseline-median")
plt.title(scenario_name)
plt.legend()
