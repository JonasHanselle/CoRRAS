...
figures_path = "../Masters_Thesis/masters-thesis/gfx/plots/hinge/"
# scenario_names = ["SAT11-RAND", "SAT11-INDU", "SAT11-HAND"]
scenario_names = ["MIP-2016", "SAT11-HAND", "CSP-2010"]
...
for measure in measures:
    ...
    for index, (scenario_name, use_max_inverse_transform, scale_target_to_unit_interval) in enumerate(param_product):
        ...
        try:
            ...
            corras = pd.read_csv(
                evaluations_path + "corras-linhinge-evaluation-" + scenario_name + ".csv")
        except:
            print("Scenario " + scenario_name +
                  " not found in corras evaluation data!")
            continue
