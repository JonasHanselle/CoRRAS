...
splits = [4]
params = [scenario_names, lambda_values, epsilon_values, splits, seeds, use_quadratic_transform_values,
...
for index, (scenario_name, lambda_value, epsilon_value, split, seed, use_quadratic_transform, use_max_inverse_transform, scale_target_to_unit_interval) in enumerate(param_product):
    ...
    filename = "linear-hinge" + "-" + params_string + ".csv"
    loss_filename = "linear-hinge" + "-" + params_string + "-losses.csv"
