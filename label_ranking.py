...
for split_num, split in enumerate(kf.split(df)):
    ...
    for portion in training_portions:
        ...
        model1.fit(train_rankings,None,train_features,None,lambda_value=1,regression_loss="Squared", maxiter=5)
        model2.fit_np(train_rankings_np,None,train_features_np,None,lambda_value=1,regression_loss="Squared", maxiter=5)
        ...
        # nll = model.vectorized_nll(train_rankings_np[:4],train_features_np[:4],test_weights)
        # print("nll", nll)
#         current_taus = []
