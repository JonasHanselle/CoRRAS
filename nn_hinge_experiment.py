...
result_path = "./results-nnh/"
loss_path = "./losses-nnh/"
...
for scenario_name, lambda_value, epsilon_value, split, seed, learning_rate, es_interval, es_patience, es_val_ratio, batch_size in shard:
    ...
    model.fit(len(scenario.algorithms), rank, inst,
                perf, lambda_value=lambda_value, epsilon_value=epsilon_value, regression_loss="Squared", num_epochs=5000, learning_rate=learning_rate, batch_size=batch_size, seed=seed, patience=es_patience, es_val_ratio=es_val_ratio, reshuffle_buffer_size=1000, early_stop_interval=es_interval, log_losses=True)
    ...
    for index, row in test_scenario.feature_data.iterrows():
        ...
        result_data_corras.append(
            [split, index, lambda_value, epsilon_value, seed, learning_rate, es_interval, es_patience, es_val_ratio, batch_size, predicted_ranking, *predicted_performances])
