...
ranks = comparison_frame_par10.iloc[:,4:7].rank(axis=1)
print(ranks.head())

# names = ["first", "third", "second", "fourth" ]
names = comparison_frame_par10.columns[4:7].to_list()
print(names)
avranks = []
for name in names:
...
print(names)
print(avranks)
cd = Orange.evaluation.compute_CD(avranks, len(comparison_frame_par10)) #tested on 30 datasets
