...
#                                      "baseline-evaluation-random-forest" +
#                                      scenario_name + ".csv")
...
#         scenario_name, val_rf, val_lr, val_pl_linear, val_pl_quad, val_nnh
#     ])
...
for scenario_name in scenario_names:
    ...
    comparison_data.append([
        scenario_name, val_rf, val_lr, val_pl_linear, val_pl_quad, val_hinge_linear, val_hinge_quad, val_nnh
    ])
comparison_frame = pd.DataFrame(
    data=comparison_data,
    columns=["Scenario", "RF", "LR", "PL-Lin", "PL-Quad", "Hinge-Lin", "Hinge-Quad", "Hinge-NN"])
