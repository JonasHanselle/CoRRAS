    ...
    def __init__(self, *args, **kwargs):
        ...
        def create_performances(feature_list):
            ...
            for features in feature_list:
                ...
                performances.append([performance_1])
            return performances
        ...
        self.train_performances = pd.DataFrame(data=performances_train,columns=["alg1"])
        self.test_performances = pd.DataFrame(data=performances_test,columns=["alg1"])
        self.train_ranking = pd.DataFrame(data=rankings_train,columns=["alg1"])
        self.test_ranking = pd.DataFrame(data=rankings_test,columns=["alg1"])
