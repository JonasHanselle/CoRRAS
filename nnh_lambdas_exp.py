...
params = [scenarios, lambda_values, epsilon_values, splits, seeds,
          learning_rates, es_intervals, es_patiences, es_val_ratios, batch_sizes, layer_sizes_vals, activation_functions, use_weighted_samples_values, scale_target_to_unit_interval_values, use_max_inverse_transform_values]
    ...
    try:
        ...
        for index, row in test_scenario.feature_data.iterrows():
            ...
            result_data_corras.append(
                [split, index, lambda_value, epsilon_value, seed, learning_rate, es_interval, es_patience, es_val_ratio, batch_size, str(layer_size), activation_function, use_weighted_samples, scale_target_to_unit_interval, use_max_inverse_transform, *predicted_performances])
        ...
        result_columns_corras = [
            "split", "problem_instance", "lambda", "epsilon", "seed", "learning_rate", "es_interval", "es_patience", "es_val_ratio", "batch_size", "layer_sizes", "activation_function", "use_weighted_samples", "scale_target_to_unit_interval", "use_max_inverse_transform"]
